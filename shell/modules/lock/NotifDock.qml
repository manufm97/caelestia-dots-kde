...
ColumnLayout {
    ...
    StyledText {
        ...
        text: Notifs.list.length > 0 ? "%1 notificación%2".arg(Notifs.list.length).arg(Notifs.list.length === 1 ? "" : "es") : "Notificaciones"
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                StyledText {
                    ...
                    text: Config.lock.hideNotifs ? "Desbloquear para notificaciones" : "Sin notificaciones"
